...
/**
 * Created by Sanat on 8/18/2017.
 */

public class UniversalImageLoder {
    private static final int defaultImage = R.drawable.ic_profile;

    private Context mContext;

    public UniversalImageLoder(Context mContext) {
     ...
     * It cant be used if the images are being changed in the Fragment/ Activity
